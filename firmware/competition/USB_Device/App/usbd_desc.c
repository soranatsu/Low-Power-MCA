...
#define USBD_MANUFACTURER_STRING     "NUCOM Team"
#define USBD_PID     0x5740
#define USBD_PRODUCT_STRING     "NUCOM G474 DAQ"
#define USBD_CONFIGURATION_STRING     "NUCOM DAQ CDC"
#define USBD_INTERFACE_STRING     "DAQ Command Port"
